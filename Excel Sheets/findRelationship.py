...
# a bit more readable
# dataPath = (r'/home/pi/Documents/Basketball-Analysis/Excel Sheets/Team Stats ' + dateString + '.csv')
dataPath = (r'C:\Users\Vincent\Documents\GitHub\Basketball-Analysis\Excel Sheets\Team Stats ' + dateString + '.csv')
