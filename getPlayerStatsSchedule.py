...
import schedule
import gspread
from nbaSecrets import nbaSeasonFolderId, seasonDashboardURL
from nbaSecrets import nbaCareerFolderId, careerDashboardURL

print('Running getPlayerStats.py')
...
def getStats():
    ...
    shP = gc.create(f'2021 Player Data as of {dateString}',folder_id=nbaSeasonFolderId)
    shC = gc.create(f'Active Player Career Data as of {dateString}',folder_id=nbaCareerFolderId)
